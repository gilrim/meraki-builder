...
> This document preserves the early CGI/PAM configuration-interface design for project history. It does not describe the current configd Unix-socket/WebSocket architecture.
